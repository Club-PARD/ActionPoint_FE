  ...
  export default function MainPage() {
    ...
    const toggleActionPoint = async (pointId: number) => {
      try {
        await axios.patch(
          `${process.env.NEXT_PUBLIC_API_URL}/acitonpoints/${pointId}/toggle`
        );
              ...
              {selectedProject ? (
                <ActionPointCard
                  ...
                  toggleActionPoint={(id, pointContent) => {
                    ...
                    if (found) toggleActionPoint(found.actionPointId); // 서버에 PATCH 요청
                  }}
                />
              ) : (
